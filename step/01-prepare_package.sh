...
#svn co https://github.com/immortalwrt/immortalwrt/trunk/package/ctcgfw/shadowsocks-rust package/lean/shadowsocks-rust
...
#fixed -U with ss-rust
pushd package/lean/
wget -qO - https://github.com/fw876/helloworld/pull/439.patch | patch -Rp1
popd
