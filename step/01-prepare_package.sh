...
wget -P package/base-files/files/usr/bin/irq_optimize.sh https://github.com/QiuSimons/R2S-OpenWrt/raw/master/PATCH/irq_optimize.sh
wget -P package/base-files/files/etc/init.d/irq_optimize https://github.com/QiuSimons/R2S-OpenWrt/raw/master/PATCH/irq_optimize
#定时重启
